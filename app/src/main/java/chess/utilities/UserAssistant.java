...
public class UserAssistant {
    ...
    public void displayControls() {
        LOGGER.info("""
                ...
                For example, in order to move a piece from point{x=1,y=2} to point{x=3,y=3}, one must write '1,2 3,3' 
                in the command line and then press ENTER to register the command.
